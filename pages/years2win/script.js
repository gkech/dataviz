   ...
   .then(function (data) {
    ...
    svg
     ...
     svg
       ...
       .enter()
       .append("circle")
       .attr("cx", function (d) { return x(d.prize_year); })
       .attr("cy", function (d) { return y(d.years_to_win); })
       .attr("r",9)
     ...
     legendContainer.append("div").attr("class", "y2w-legend-title").text("Legend");
     ...
     legendItems.append("span").text(function (d) { return d; });
   })
